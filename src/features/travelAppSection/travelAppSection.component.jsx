    ...
    <div className="travelAppSectionHolder">
      <div className="travelAppSection">
        <div className="travelAppSectionDescription">
          ...
          <p>
            Discover the ultimate travel companion with our travel app. Designed
            to keep up with your wanderlust, it offers seamless navigation,
            real-time updates, and personalized recommendations. Whether you're
            exploring a new city or embarking on a cross-country adventure, our
            app is your trusted guide.
          </p>
