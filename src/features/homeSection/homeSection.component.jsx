    ...
    return(
        <div className="homeSectionHolder">
            <div className="homeSectionDescription">
                ...
                <p>"Embark on a journey like never before with our brand-new booking and travel website! Discover amazing destinations, find unbeatable deals, and plan your dream getaway all in one place. Sign up for free today and let your adventure begin!"</p>
            </div>
